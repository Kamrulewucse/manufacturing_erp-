@extends('layouts.app')
@section('title','Create Journal Voucher(JV)')
@section('style')
    <style>
        .form-control {
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('accounts.journal_voucher.create') }}"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group {{ $errors->has('financial_year') ? 'has-error' :'' }}">
                                                    ...
                                                    <select class="form-control select2" name="financial_year" id="financial_year">
                                                        ...
                                                        @for($i=2022; $i <= date('Y'); $i++)
                                                            <option value="{{ $i }}" {{ old('financial_year',dateToFinancialYear()) == $i ? 'selected' : '' }}>{{ $i }}-{{ $i+1 }}</option>
                                                        @endfor
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('date') ? 'has-error' :'' }}">
                                                    ...
                                                    <input type="text" value="{{ old('date') }}" autocomplete="off"
                                                           id="date" name="date" class="form-control date-picker-fiscal-year"
                                            ...
                                            <div class="col-md-12" id="payee_select_area">
                                                <div
                                                    ...
                                                    <select class="form-control select2" id="employee_party"
                                                        ...
                                                        @if (old('employee_party') != '')
                                                            <option value="{{ old('employee_party') }}"
                                                                    selected>{{ old('select_name') }}</option>
                                                        @endif
                                                    </select>
                                        ...
                                        <div class="row client_name_area">
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('name') ? 'has-error' :'' }}">
                                                    <label for="name">Employee/Party Name <span
                                                            class="text-danger">*</span></label>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('accounts.journal_voucher') }}" class="btn btn-default float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
