    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('accounts.journal_voucher.edit',['journalVoucher'=>$journalVoucher->id]) }}"
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('accounts.cheque_receipt') }}" class="btn btn-default float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
