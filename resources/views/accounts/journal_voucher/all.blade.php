    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form target="_blank" action="{{ route('journal_voucher_range_print') }}" class="row">
                            <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-outline card-default">
                <div class="card-header">
                    <a href="{{ route('journal_voucher.create') }}" class="btn btn-dark bg-gradient-dark">Journal Voucher Create</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
