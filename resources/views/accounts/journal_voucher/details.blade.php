...
@section('content')
    <div class="card">
        <div class="card-header">
            <a target="_blank" class="btn btn-dark btn-sm" href="{{ route('journal_voucher_print',['journalVoucher'=>$journalVoucher->id]) }}"><i class="fa fa-print"></i></a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th width="2%" class="text-center">:</th>
                            <td width="">{{ employeeClientInfo($journalVoucher->payee_depositor_account_head_id)->mobile ?? '' }}</td>
