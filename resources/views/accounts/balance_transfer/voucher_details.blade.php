...
@section('content')
    <div class="card">
        <div class="card-header">
            <a target="_blank" class="btn btn-dark btn-sm" href="{{ route('balance_transfer_voucher_print',['balanceTransfer'=>$balanceTransfer->id]) }}"><i class="fa fa-print"></i></a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <h3 class="text-center m-0" style="font-size: 28px !important;">Bank Voucher</h3>
                ...
                <div class="col-12">
                    <table class="table body-table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="border-top: 1px solid #000 !important;border-bottom: 1px solid #000 !important;">DR.</td>
