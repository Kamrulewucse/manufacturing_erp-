...
<head>
    ...
    <title>Cheque_Receipt_{{$from}}_to_{{ $to }}</title>
                ...
                <div class="col-12">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td width="">{{ employeeClientInfo($receiptPayment->payee_depositor_account_head_id)->name ?? '' }}, {{ employeeClientInfo($receiptPayment->payee_depositor_account_head_id)->designation ?? '' }}</td>
