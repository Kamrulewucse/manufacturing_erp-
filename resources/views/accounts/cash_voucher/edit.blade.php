@extends('layouts.app')
@section('title')
    Edit Cash Voucher(CV) # <b>{{ $receiptPayment->receipt_payment_no }}</b>
@endsection
@section('style')
    <style>
        .select2 {
        ...
        .cash_account_code_area > .select2{
            width: 100% !important;
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('cash_voucher.edit',['receiptPayment'=>$receiptPayment->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group {{ $errors->has('cash_account_code') ? 'has-error' :'' }}">
                                                    <label for="cash_account_code">Cash Disbursed Point Code</label>
                                                    <input type="hidden" name="cash_account_code" value="{{ $receiptPayment->payment_account_head_id }}">
                                                    <input readonly id="cash_account_code" value="Account:{{ $receiptPayment->paymentAccountHead->name ?? '' }}|Account Code:{{ $receiptPayment->paymentAccountHead->account_code }}" type="text" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group {{ $errors->has('notes') ? 'has-error' :'' }}">
                                                        <input type="text" id="notes" value="{{ old('notes',$receiptPayment->notes) }}" name="notes" class="form-control" placeholder="Enter Payment Details (Narration)...">
                                                        @error('notes')
                                                        <span class="help-block">{{ $message }}</span>
                                                        @enderror
                                                    </div>
