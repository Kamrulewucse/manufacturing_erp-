...
<head>
    ...
    <title>Cash_Voucher_{{ $from }}_to_{{ $to }}</title>
...
<div class="single-page">
        ...
        <section class="invoice">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <h3 class="text-center m-0" style="font-size: 50px !important;">Cash Voucher</h3>
            ...
            <div class="row" style="min-height: 750px !important;">
    ...
    <div class="footer-signature-area">
        <div class="row signature-area" style="padding:0 50px!important;">
            ...
            <div class="col text-center"><span style="border: 1px solid #000 !important;display: block;padding: 18px;font-size: 20px;font-weight: bold">Input By</span></div>
        </div>
    </div>
</div>
@endforeach
