@extends('layouts.app')
@section('title','Create Cash Voucher(CV)')
@section('style')
    <style>
        .form-control {
            ...
            <div class="card card-outline card-default">
                ...
                <form enctype="multipart/form-data" action="{{ route('cash_voucher.create') }}" class="form-horizontal" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('date') ? 'has-error' :'' }}">
                                                    ...
                                                    <input type="text" autocomplete="off" id="date" value="{{ old('date',date('Y-m-d')) }}" name="date" class="form-control date-picker" placeholder="Enter Date">
                                                    @error('date')
                                                    <span class="help-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group bank_account_area {{ $errors->has('cash_account_code') ? 'has-error' :'' }}">
                                                    <label for="cash_account_code">Cash Disbursed Point Code <span class="text-danger">*</span></label>
                                                    <select style="max-width: 300px !important;" class="form-control select2" id="cash_account_code" name="cash_account_code">
                                                        <option value="">Search Cash Account Code</option>
                    ...
                    <div class="card-footer">
                        <button id="btn-save" type="submit" class="btn btn-dark">Save</button></div>
                    <!-- /.card-footer -->
                </form>
            </div>
            <!-- /.card -->
