@extends('layouts.app')
@section('title')
    Edit Cash Receipt(CR)# <b>{{ $receiptPayment->receipt_payment_no }}</b>
@endsection
@section('style')
    <style>
        .form-control {
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('cash_receipt.edit',['receiptPayment'=>$receiptPayment->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group {{ $errors->has('cash_account_code') ? 'has-error' :'' }}">
                                                    ...
                                                    <input type="hidden" name="cash_account_code" value="{{ $receiptPayment->payment_account_head_id }}">
                                                    <input readonly id="cash_account_code" value="Cash:{{ $receiptPayment->paymentAccountHead->name }}|Code:{{ $receiptPayment->paymentAccountHead->account_code }}" type="text" class="form-control">
