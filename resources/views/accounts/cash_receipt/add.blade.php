                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('date') ? 'has-error' :'' }}">
                                                    ...
                                                    <input type="text" value="{{ old('date',date('Y-m-d')) }}" autocomplete="off" id="date" name="date" class="form-control date-picker" placeholder="Enter Date">
                                                    @error('date')
                                                    <span class="help-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group {{ $errors->has('cash_account_code') ? 'has-error' :'' }}">
                                                    <label for="cash_account_code">Cash Receipt Point Code</label>
                                                    <select class="form-control select2" id="cash_account_code" name="cash_account_code">
                                                        <option value="">Search Name of Cash Receipt Point Code</option>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="payee_select_area">
                                                <div class="form-group {{ $errors->has('depositor') ? 'has-error' :'' }}">
                                                    <label for="payee">Depositor <span class="text-danger">*</span></label>
                                                    <select class="form-control select2" id="payee" style="width: 100%;" name="depositor" data-placeholder="Search Depositor">
                                                        <option value="">Search Depositor</option>
                                                        @if (old('depositor') != '')
                                                            <option value="{{ old('depositor') }}" selected>{{ old('payee_select_name') }}</option>
                                                        @endif
                                                    </select>
                                                    @error('depositor')
                                                    <span class="help-block">{{ $message }}</span>
                                        ...
                                        <div class="row hide client_name_area">
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('depositor_name') ? 'has-error' :'' }}">
                                                    <label for="payee_name">Depositor's Name <span class="text-danger">*</span></label>
                                                    <input type="text" name="depositor_name" value="{{ old('depositor_name') }}" id="payee_name" class="form-control" placeholder="Enter Depositor's Name">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('designation') ? 'has-error' :'' }}">
                                                    ...
                                                    <input type="text" name="designation" value="{{ old('designation') }}" id="designation" class="form-control" placeholder="Enter Designation">
                                                    @error('designation')
                                                    <span class="help-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('address') ? 'has-error' :'' }}">
                                                    ...
                                                    <input type="text" name="address" value="{{ old('address') }}" id="address" class="form-control" placeholder="Enter Address">
                                                    @error('address')
                                                    <span class="help-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group {{ $errors->has('nature_of_organization') ? 'has-error' :'' }}">
                                                    ...
                                                    <select name="nature_of_organization" id="nature_of_organization" class="form-control select2">
                                                        ...
                                                        @foreach($taxSections as $taxSection)
                                                            <option {{ old('nature_of_organization') == $taxSection->id ? 'selected' : ''  }} value="{{ $taxSection->id }}">{{ $taxSection->source }} - {{ $taxSection->section }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group {{ $errors->has('notes') ? 'has-error' :'' }}">
                                                        <input type="text" value="{{ old('notes') }}" name="notes" class="form-control" placeholder="Enter Receipt Details (Narration)...">
                                                        @error('notes')
                                                        <span class="help-block">{{ $message }}</span>
                                                        @enderror
                                                    </div>
