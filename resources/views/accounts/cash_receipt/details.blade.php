@extends('layouts.app')
@section('title')
    Cash Receipt No:{{ $receiptPayment->receipt_payment_no }}
@endsection
@section('style')
    <style>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <a target="_blank" class="btn btn-dark btn-sm" href="{{ route('cash_receipt_print',['receiptPayment'=>$receiptPayment->id]) }}"><i class="fa fa-print"></i></a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
