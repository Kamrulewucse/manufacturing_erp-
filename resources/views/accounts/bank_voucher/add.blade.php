@extends('layouts.app')
@section('title','Create Bank Voucher(BV)')
@section('style')
    <style>
        .form-control {
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('bank_voucher.create') }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
...
{{--                                                    <input type="text" autocomplete="off" id="date" value="{{ old('date') }}" name="date" class="form-control date-picker-fiscal-year" placeholder="Enter Date">--}}
                                                    <input type="text" class="form-control pull-right" id="date" name="date" value="{{ old('date',date('Y-m-d')) }}" autocomplete="off" placeholder="Enter Date">
                                                    @error('date')
                                                    <span class="help-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group bank_account_area {{ $errors->has('bank_account_code') ? 'has-error' :'' }}">
                                                    ...
                                                    <select style="max-width: 300px !important;" class="form-control select2" id="bank_account_code" name="bank_account_code">
                                    ...
                                    <div class="table-responsive">
                                        <fieldset>
                                            ...
                                            <table class="table other table-bordered">
                                                ...
                                                <tr>
                                                    <th class="text-left">
                                                        <a role="button" class="btn btn-success btn-sm" id="btn-add-other-voucher"><i class="fa fa-plus"></i></a>
                                                    </th>
                                                </tr>
                                                </tfoot>
                                            </table>
