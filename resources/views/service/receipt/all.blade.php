    ...
    <script>
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('service_receipt.datatable') }}',
                columns: [
                    {data: 'date', name: 'date',searchable:false},
                    {data: 'order_no', name: 'order_no'},
                    {data: 'client', name: 'client.name'},
                    {data: 'service_payment_type', name: 'service_payment_type'},
            ...
            $('#modal-btn-pay').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('service.make_receipt') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
