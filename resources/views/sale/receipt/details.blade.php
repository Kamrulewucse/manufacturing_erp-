                                    ...
                                    <tbody>
                                        @foreach ($order->products->groupBy('product.name') as $productName => $products)
                                            <tr>
                                                ...
                                                <td>{{ $productName }}
                                                    @if (strlen($products[0]['warranty']) > 0)
                                                ...
                                                <td class="text-right">
                                                    ৳{{ number_format($product->selling_price * $products->count(), 2) }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="row" id="{{ $order->due > 0 ? 'printDueReceipt' : 'printPaidReceipt' }}">
                        <div class="offset-7 col-md-5 ">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Earlier Dues</th>
                                    <td>৳ {{ number_format($customer_data->dues - $order->due, 2) }}</td>
                                </tr>
                                <tr>
                                    <th>Total Dues</th>
                                    <td>৳{{ number_format($customer_data->dues, 2) }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
