...
@section('content')
    <form method="POST" enctype="multipart/form-data"  action="{{ route('agm_receipt.edit',['order'=>$order->id]) }}">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('agm_note') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" id="agm_note" name="agm_note" value="{{ old('agm_note', $order->agm_note) }}" class="form-control">
                                    @error('agm_note')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('sale_note') ? 'has-error' :'' }}">
                                    ...
                                    <div>
                                        <input type="textarea" class="form-control pull-right" name="sale_note" disabled
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('service_note') ? 'has-error' :'' }}">
                                    ...
                                    <div>
                                        <input type="textarea" class="form-control pull-right" name="service_note" disabled
                                               value="{{ $order->service_note }}" autocomplete="off">
                                    </div>
                                    <!-- /.input group -->
                                    @error('service_note')
                                    <span class="help-block">{{ $message }}</span>
                        ...
                        <div class="row" id="new_customer_area">
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('customer_name') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" disabled id="customer_name" name="customer_name" value="{{ old('customer_name',$order->customer->name??'') }}" class="form-control">
                                    @error('customer_name')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('mobile_no') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" disabled id="mobile_no" value="{{ old('mobile_no',$order->customer->mobile_no??'') }}" name="mobile_no" class="form-control" >
                                    @error('mobile_no')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('address') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" disabled id="address" value="{{ old('address',$order->customer->address??'') }}" name="address" class="form-control"  >
                                    @error('address')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('email') ? 'has-error' :'' }}">
                                    <label>Email</label>
                                    <input type="email" disabled id="email" value="{{ old('email',$order->customer->email??'') }}" name="email" class="form-control"  >
                                    @error('email')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row" id="new_dealer_area">
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('dealer_name') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" disabled id="dealer_name" name="dealer_name" value="{{ old('dealer_name',$order->dealer->name??'') }}" class="form-control">
                                    @error('dealer_name')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('dealer_mobile_no') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" disabled id="dealer_mobile_no" value="{{ old('dealer_mobile_no',$order->dealer->mobile??'') }}"
                                           name="dealer_mobile_no" class="form-control" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('dealer_address') ? 'has-error' :'' }}">
                                    ...
                                    <input type="text" disabled id="dealer_address" value="{{ old('dealer_address',$order->dealer->address??'') }}" name="dealer_address" class="form-control"  >
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('dealer_email') ? 'has-error' :'' }}">
                                    ...
                                    <input type="email" disabled id="dealer_email" value="{{ old('dealer_email',$order->dealer->email??'') }}" name="dealer_email" class="form-control"  >
                                    @error('dealer_email')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('dealer_code') ? 'has-error' :'' }}">
                                    <label>Dealer</label>
                                    <input type="text" disabled id="dealer_code" value="{{ old('dealer_code',$order->dealer->dealer_code??'') }}" name="dealer_code" class="form-control"  >
                                    @error('dealer_code')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                                        ...
                                        @else
                                            @foreach($order->products as $product)
                                                <tr class="product-item">
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="number" class="form-control quantity" name="quantity[]" readonly   value="{{ $product->quantity}}">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="number" class="form-control unit_price" name="unit_price[]" readonly  value="{{ $product->unit_price}}">
                                                        </div>
                                                    </td>
                                                    <td  class="total-cost">৳ 0.00</td>
                                                    <td class="text-center">
...
{{--                        <button class="btn-approve btn btn-primary">Approve</button>--}}
                    </div>
                </div>
            </div>
        </div>
