        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Dealer Payment Information</h4>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('dealer_payment.datatable') }}',
                columns: [
                    {data: 'name', name: 'name'},
            ...
            $('#modal-btn-pay').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('dealer_payment.make_payment') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
